    ...
    <div name="work" className="w-full h-full bg-[#0a192f] text-gray-300">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          ...
          <p className="py-6"> Check out some of my proyects</p>
        </div>
        {/* Container */}
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 mt-[70px]">
          ...
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 items-center mt-[70px]">
              <span className="text-2xl font-bold text-white tracking-wider">
                React JS Application
              </span>
              <div className="pt-8 text-center">
          ...
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 text-center mt-[70px]">
              <span className="text-2xl font-bold text-white tracking-wider">
                React JS Application
              </span>
              <div className="pt-8 text-center">
